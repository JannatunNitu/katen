                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="{{auth()->user()->profile_img ? asset('storage/users/'.auth()->user()->profile_img) : env('AVATAR_API').auth()->user()->name }}" alt="" />
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="{{auth()->user()->profile_img ? asset('storage/users/'.auth()->user()->profile_img) :env('AVATAR_API').auth()->user()->name }}" alt="image">
                        </div>
                        <div class="content">
                          <h4 class="text-sm">{{ str(auth()->user()->name)->headline() }}</h4>

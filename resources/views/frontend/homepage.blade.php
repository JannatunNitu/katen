			...
			<div class="row gy-4">
				...
				<div class="col-lg-8">
					...
					<div class="post post-classic rounded bordered">
						...
						<div class="details">
							<ul class="meta list-inline mb-0">
								<li class="list-inline-item"><a href="classic.html#"><img src="{{asset('frontend/images/other/author-sm.png')}} " class="author" alt="author"/>Katen Doe</a></li>
								<li class="list-inline-item">29 March 2021</li>
								...
								<div class="post-carousel-widget">
									...
									<div class="post post-carousel">
										<div class="thumb rounded">
											...
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{asset('frontendimages/widgets/widget-carousel-1.jpg')}} " alt="post-title" />
												</div>
											</a>
										</div>
										<h5 class="post-title mb-0 mt-4"><a href="blog-single.html">5 Easy Ways You Can Turn Future Into Success</a></h5>
